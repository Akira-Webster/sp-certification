...
CREATE TABLE [dbo].[Answers] (
    ...
    [Identity]   NVARCHAR (1)     NOT NULL,
    [QuestionID] UNIQUEIDENTIFIER NOT NULL
);


GO
PRINT N'Creating PK_Answers...';


GO
ALTER TABLE [dbo].[Answers]
    ADD CONSTRAINT [PK_Answers] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[Answers].[IX_QuestionID]...';


GO
CREATE NONCLUSTERED INDEX [IX_QuestionID]
    ON [dbo].[Answers]([QuestionID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, SORT_IN_TEMPDB = OFF, DROP_EXISTING = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF, ONLINE = OFF, MAXDOP = 0)
    ON [PRIMARY];
...
GO
PRINT N'Creating PK_Choices...';


GO
ALTER TABLE [dbo].[Choices]
    ADD CONSTRAINT [PK_Choices] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[Choices].[IX_ProblemID]...';


GO
CREATE NONCLUSTERED INDEX [IX_ProblemID]
    ON [dbo].[Choices]([ProblemID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, SORT_IN_TEMPDB = OFF, DROP_EXISTING = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF, ONLINE = OFF, MAXDOP = 0)
    ON [PRIMARY];
...
GO
PRINT N'Creating PK_Courses...';


GO
ALTER TABLE [dbo].[Courses]
    ADD CONSTRAINT [PK_Courses] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[Problems]...';
...
GO
PRINT N'Creating PK_Problems...';


GO
ALTER TABLE [dbo].[Problems]
    ADD CONSTRAINT [PK_Problems] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[Problems].[IX_CourseID]...';


GO
CREATE NONCLUSTERED INDEX [IX_CourseID]
    ON [dbo].[Problems]([CourseID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, SORT_IN_TEMPDB = OFF, DROP_EXISTING = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF, ONLINE = OFF, MAXDOP = 0)
    ON [PRIMARY];
...
GO
PRINT N'Creating [dbo].[Questions].[IX_Problem_ID]...';


GO
CREATE NONCLUSTERED INDEX [IX_Problem_ID]
    ON [dbo].[Questions]([Problem_ID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, SORT_IN_TEMPDB = OFF, DROP_EXISTING = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF, ONLINE = OFF, MAXDOP = 0)
    ON [PRIMARY];


GO
PRINT N'Creating [dbo].[Questions].[IX_TestID]...';


GO
CREATE NONCLUSTERED INDEX [IX_TestID]
    ON [dbo].[Questions]([TestID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, SORT_IN_TEMPDB = OFF, DROP_EXISTING = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF, ONLINE = OFF, MAXDOP = 0)
    ON [PRIMARY];


GO
PRINT N'Creating [dbo].[Tests]...';
...
GO
PRINT N'Creating PK_Tests...';


GO
ALTER TABLE [dbo].[Tests]
    ADD CONSTRAINT [PK_Tests] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF);


GO
PRINT N'Creating [dbo].[Tests].[IX_Course_ID]...';


GO
CREATE NONCLUSTERED INDEX [IX_Course_ID]
    ON [dbo].[Tests]([Course_ID] ASC) WITH (ALLOW_PAGE_LOCKS = ON, ALLOW_ROW_LOCKS = ON, PAD_INDEX = OFF, SORT_IN_TEMPDB = OFF, DROP_EXISTING = OFF, IGNORE_DUP_KEY = OFF, STATISTICS_NORECOMPUTE = OFF, ONLINE = OFF, MAXDOP = 0)
    ON [PRIMARY];
...
GO
PRINT N'Creating FK_Answers_Questions_QuestionID...';


GO
ALTER TABLE [dbo].[Answers] WITH NOCHECK
    ADD CONSTRAINT [FK_Answers_Questions_QuestionID] FOREIGN KEY ([QuestionID]) REFERENCES [dbo].[Questions] ([ID]) ON DELETE CASCADE ON UPDATE NO ACTION;
...
GO
PRINT N'Creating FK_Choices_Problems_ProblemID...';


GO
ALTER TABLE [dbo].[Choices] WITH NOCHECK
    ADD CONSTRAINT [FK_Choices_Problems_ProblemID] FOREIGN KEY ([ProblemID]) REFERENCES [dbo].[Problems] ([ID]) ON DELETE CASCADE ON UPDATE NO ACTION;


GO
PRINT N'Creating FK_Problems_Courses_CourseID...';


GO
ALTER TABLE [dbo].[Problems] WITH NOCHECK
    ADD CONSTRAINT [FK_Problems_Courses_CourseID] FOREIGN KEY ([CourseID]) REFERENCES [dbo].[Courses] ([ID]) ON DELETE CASCADE ON UPDATE NO ACTION;


GO
PRINT N'Creating FK_Questions_Problems_Problem_ID...';


GO
ALTER TABLE [dbo].[Questions] WITH NOCHECK
    ADD CONSTRAINT [FK_Questions_Problems_Problem_ID] FOREIGN KEY ([Problem_ID]) REFERENCES [dbo].[Problems] ([ID]) ON DELETE NO ACTION ON UPDATE NO ACTION;


GO
PRINT N'Creating FK_Questions_Tests_TestID...';


GO
ALTER TABLE [dbo].[Questions] WITH NOCHECK
    ADD CONSTRAINT [FK_Questions_Tests_TestID] FOREIGN KEY ([TestID]) REFERENCES [dbo].[Tests] ([ID]) ON DELETE CASCADE ON UPDATE NO ACTION;


GO
PRINT N'Creating FK_Tests_Courses_Course_ID...';


GO
ALTER TABLE [dbo].[Tests] WITH NOCHECK
    ADD CONSTRAINT [FK_Tests_Courses_Course_ID] FOREIGN KEY ([Course_ID]) REFERENCES [dbo].[Courses] ([ID]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
GO
ALTER TABLE [dbo].[Answers] WITH CHECK CHECK CONSTRAINT [FK_Answers_Questions_QuestionID];

ALTER TABLE [dbo].[Choices] WITH CHECK CHECK CONSTRAINT [FK_Choices_Problems_ProblemID];

ALTER TABLE [dbo].[Problems] WITH CHECK CHECK CONSTRAINT [FK_Problems_Courses_CourseID];

ALTER TABLE [dbo].[Questions] WITH CHECK CHECK CONSTRAINT [FK_Questions_Problems_Problem_ID];

ALTER TABLE [dbo].[Questions] WITH CHECK CHECK CONSTRAINT [FK_Questions_Tests_TestID];

ALTER TABLE [dbo].[Tests] WITH CHECK CHECK CONSTRAINT [FK_Tests_Courses_Course_ID];
